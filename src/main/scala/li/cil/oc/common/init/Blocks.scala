...
object Blocks {
  ...
  def init(): Unit = {
    ...
    BLOCKS.register(Constants.BlockName.ChameliumBlock,    () => Items.registerBlock(new ChameliumBlock(Properties.of(Material.STONE).strength(2, 5)), Constants.BlockName.ChameliumBlock, defaultItemProps))
    ...
    BLOCKS.register(Constants.BlockName.Keyboard,          () => Items.registerBlock(new Keyboard(Properties.of(Material.STONE).strength(2, 5).noOcclusion), Constants.BlockName.Keyboard, defaultItemProps))
    ...
    BLOCKS.register(Constants.BlockName.PowerConverter,    () => Items.registerBlock(new PowerConverter(defaultProps), Constants.BlockName.PowerConverter,
    ...
    BLOCKS.register(Constants.BlockName.Print,             () => Items.registerBlock(new Print(Properties.of(Material.METAL).strength(1, 5).noOcclusion.dynamicShape), Constants.BlockName.Print, new Item.Properties()))
    BLOCKS.register(Constants.BlockName.RobotAfterimage,   () => Items.registerBlockOnly(new RobotAfterimage(Properties.of(Material.AIR).noCollission.instabreak.noOcclusion.dynamicShape), Constants.BlockName.RobotAfterimage))
    ...
    // v1.5.10
    BLOCKS.register(Constants.BlockName.Endstone,          () => Items.registerBlock(new FakeEndstone(Properties.of(Material.STONE).strength(3, 15)), Constants.BlockName.Endstone, defaultItemProps))
